...
```
npm create cloudflare@latest -- --template=cloudflare/templates/muddy-shape-3f6d
```

## Preview Deployment

A live public deployment of this template is available at [https://muddy-shape-3f6d.templates.workers.dev](https://muddy-shape-3f6d.templates.workers.dev)
